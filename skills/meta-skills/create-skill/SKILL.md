...
```bash
# Simple skill
${PAI_DIR}/skills/[category]/[skill-name]/
└── SKILL.md
...
For detailed context: `read ${PAI_DIR}/skills/[category]/[skill-name]/CLAUDE.md`
```
...
For complete guide with examples: `read ${PAI_DIR}/skills/meta-skills/create-skill/CLAUDE.md`
For templates: `ls ${PAI_DIR}/skills/meta-skills/create-skill/templates/`
