...
```bash
cp ${PAI_DIR}/skills/meta-skills/create-skill/templates/[template-name].md \
   ${PAI_DIR}/skills/[category]/[new-skill-name]/SKILL.md
```
...
- Complete guide: `read ${PAI_DIR}/skills/meta-skills/create-skill/CLAUDE.md`
- Quick reference: `read ${PAI_DIR}/skills/meta-skills/create-skill/SKILL.md`
