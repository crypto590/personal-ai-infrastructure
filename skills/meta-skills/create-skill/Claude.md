...
```
${PAI_DIR}/skills/[category]/fabric-patterns/
...
```
${PAI_DIR}/skills/[category]/development/
...
For full context: `read ${PAI_DIR}/skills/[category]/[name]/CLAUDE.md`
For components: `read ${PAI_DIR}/skills/[category]/[name]/[subdirectory]/`
```
...
**For Simple Skill:**
```bash
mkdir -p ${PAI_DIR}/skills/[category]/[skill-name]
...
```bash
mkdir -p ${PAI_DIR}/skills/[category]/[skill-name]
mkdir -p ${PAI_DIR}/skills/[category]/[skill-name]/[component-dirs]
...
For full methodology: `read ${PAI_DIR}/skills/[category]/[name]/CLAUDE.md`
For components: `read ${PAI_DIR}/skills/[category]/[name]/[component]/`
...
For methodology: `read ${PAI_DIR}/skills/[category]/[name]/CLAUDE.md`
```
...
**Structure:**
```
skills/[category]/fabric-patterns/
└── SKILL.md
```
...
## Advanced Usage
For comprehensive methodology: `read ${PAI_DIR}/skills/[category]/[name]/CLAUDE.md`

## Component Details
For [specific component]: `read ${PAI_DIR}/skills/[category]/[name]/[component]/`
```
