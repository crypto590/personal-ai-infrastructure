...
metadata:
  ...
  version: 1.0.0
  category: technical
  tags: [obsidian, canvas, json, visualization, mind-map, flowchart]
---
...
For full canvas examples (mind maps, project boards, research canvases, flowcharts), see `references/complete-examples.md`.
