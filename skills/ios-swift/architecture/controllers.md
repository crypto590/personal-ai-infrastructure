...
- [error-handling.md](error-handling.md) - Error handling in Controllers
- [advanced-patterns.md](advanced-patterns.md) - Composition and shared Controllers
    ...
    func loadUser(id: String) async {
        ...
        loadTask = Task {
            ...
            do {
                ...
                if !Task.isCancelled {
                    // Handle error (see error-handling.md)
                }
            }
        }
...
See [advanced-patterns.md](advanced-patterns.md#shared-controllers).
...
See [advanced-patterns.md](advanced-patterns.md#controller-composition) for composition patterns.
